...
class Admin_6_edit extends StatefulWidget {
  const Admin_6_edit({super.key});

  @override
  State<Admin_6_edit> createState() => _Admin_6_editState();
}

class _Admin_6_editState extends State<Admin_6_edit> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Edit 06:00 pm contest"),
      ),
